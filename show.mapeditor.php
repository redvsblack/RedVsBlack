		...
		<div class="mapDragBar">
				...
				<!--<button type=""  id="saveMap">Save</button>
				<button type=""  id="loadMap">Load</button>//-->
		</div>
		<div id="mapCreator">
			...
			<form id="mapGenerator" method="post" >
				...
				<div class="box" id="mapSize">
					...
					<p>Map Width (Tiles):<span class="mapSlider" id="mapWidth" min="1" max="150" value="75"></span> <br /><span class="value"></span><input type="hidden" name="mapWidth" /></p>
					<p>Map Height (Tiles):<span class="mapSlider" id="mapHeight" min="1" max="150" value="75"></span><br /><span class="value"></span><input type="hidden" name="mapHeight" /></p>
					<p>Tile Width (px):<span class="mapSlider" id="cellWidth" min="16" max="40" value="24"></span> <br /><span class="value"></span><input type="hidden" name="cellWidth" /></p>
					<p>Tile Height (px):<span class="mapSlider" id="cellHeight" min="16" max="40" value="24"></span> <br /><span class="value"></span><input type="hidden" name="cellHeight" /></p>
				</div>		
				...
				<div class="box" id="terrainLayout" >
					...
					<p title="This algorithm is admittedly rough right now and hard to explain, but the version right now takes an exponential function to measure the probability at a given latitude that there will be ice.  The variable represents a denominator in the equation, effecting both the slope and the extent of ice.  For Mountains, it just slightly increases the odds that mountains will have snow.">Hotter -> Colder<span class="mapSlider" id="iceCaps" min="1" max="100" value="35"></span><br /> <span class="value" style="visibilty:hidden;"></span><input type="hidden" name="iceCaps" /></p>
					<p title="The current algorithms tend to stubbornly favor land bridges, particularly on lower #'s of iterations... this helps fight that."> Raise -> Lower Land Bridges<span class="mapSlider" id="isthmuses" min="-50" max="50" value="20"></span><br /> <span class="value" style="visibilty:hidden;"></span><input type="hidden" name="isthmuses" /></p>
					<p title="Less / More Lakes">Less -> More Lakes<span class="mapSlider" id="lakesBalance" min="0" max="100" value="10">10</span><br /><span class="value" style="visibilty:hidden;"></span><input type="hidden" name="lakesBalance" /></p>
						<p title="Less / More Forest">Less -> More Forests<span class="mapSlider" id="forestsBalance" min="0" max="100" value="20">10</span><br /><span class="value" style="visibilty:hidden;"></span><input type="hidden" name="forestsBalance" /></p>
